...
. En la página *recurso*, si desea utilizar un nombre personalizado, active la casilla de verificación *usar formato de nombre personalizado para copia Snapshot* y, a continuación, escriba un formato de nombre personalizado para el nombre de copia Snapshot.
+
