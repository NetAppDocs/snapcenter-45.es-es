...
. En la página *Recursos*, haga clic en *Agregar recurso*.
...
. En la página *Configuración de recursos*, proporcione pares personalizados de clave-valor para el recurso.
+
