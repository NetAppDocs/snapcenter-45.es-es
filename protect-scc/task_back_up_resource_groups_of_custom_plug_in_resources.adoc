...
. En la página *Recursos*, seleccione *Grupo de recursos* en la lista *Ver*.
+
...
. En la página *grupos de recursos*, seleccione el grupo de recursos del que desea realizar la copia de seguridad y, a continuación, haga clic en *realizar copia de seguridad ahora*.
