...
Para ver los requisitos mínimos del ONTAP y el complemento de la aplicación, consulte https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["Herramienta de matriz de interoperabilidad"^]
...
Sistema operativo (64 bits)
 a| 
Consulte https://mysupport.netapp.com/matrix/imt.jsp?components=100747;&solution=1257&isHWU&src=IMT["Herramienta de matriz de interoperabilidad"^]
...
. En la página *Notificaciones* del asistente, utilice el umbral de capacidad predeterminado del 90 por ciento.
