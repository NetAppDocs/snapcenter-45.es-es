...
. En la vista *Administrar copias*, seleccione *copias de seguridad* en el sistema de almacenamiento.
...
|===
. En la página *alcance de recuperación*, seleccione una de las siguientes opciones:
+
|===
| Opción | Descripción 
