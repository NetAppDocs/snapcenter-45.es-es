...
Puede hacer una copia de seguridad de un grupo de recursos bajo demanda desde la página *Recursos*. Si un grupo de recursos tiene una política anexada y una programación configurada, los backups se realizan automáticamente según esa programación.
