...
* Si desea crear un backup basado en archivos cuando una o varias bases de datos de tenant están inactivos, establezca el parámetro ALLOW_FILE_BASED_BACKUP_IFINACTIVE_ARRENDATARIOS_PRESENT en *YES* en el archivo de propiedades de HANA con el cmdlet Set-SmConfigSettings.
+
...
. En la página *recurso*, filtre los recursos de la lista desplegable *Ver* en función del tipo de recurso.
+
...
. En la página *recurso*, seleccione *usar formato de nombre personalizado para copia Snapshot* y, a continuación, escriba un formato de nombre personalizado que desee utilizar para el nombre de copia Snapshot.
+
