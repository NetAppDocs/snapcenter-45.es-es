...
summary: 'Es posible crear una conexión \(SVM\) de máquina virtual de almacenamiento y una credencial antes de usar los cmdlets de PowerShell para realizar backup, restaurar o clonar bases de datos SAP HANA.' 
---
