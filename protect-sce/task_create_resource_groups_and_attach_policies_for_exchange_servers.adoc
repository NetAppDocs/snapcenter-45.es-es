...
+
En las secciones Available Resources y Selected Resources, el nombre de la base de datos se muestra con el nombre de host. Este nombre de host solo indica que la base de datos está activa en ese host específico y que puede no asumir un backup en este host. Debe seleccionar uno o más servidores de copia de seguridad de la opción de selección del servidor, donde desea realizar la copia de seguridad en caso de que haya seleccionado la opción *copia de seguridad de copias en servidores para seleccionar en el tiempo de creación del trabajo de copia de seguridad* de la directiva.
