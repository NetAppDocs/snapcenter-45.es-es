...
+
Haga clic en *image:../media/filter_icon.gif[""]* y luego seleccione el nombre de host y el tipo de base de datos para filtrar los recursos. A continuación, puede hacer clic en *image:../media/filter_icon.gif[""]* para cerrar el panel de filtros.
...
. Para especificar un nombre personalizado para la copia de Snapshot, en la página Resources, active la casilla de verificación *usar formato de nombre personalizado para copia de Snapshot* y, a continuación, escriba el formato de nombre personalizado que desee usar para el nombre de la copia de Snapshot.
+
