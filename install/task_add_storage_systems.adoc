...
Puede añadir una SVM independiente o un clúster compuesto por múltiples SVM. Si utiliza Amazon FSX para ONTAP de NetApp, puede agregar la LIF de administrador de FSX compuesta por varias SVM mediante la cuenta fsxadmin en SnapCenter 4.5 P1 o agregar FSX SVM en SnapCenter.
